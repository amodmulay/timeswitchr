        ...
        <main className="container">
            ...
            <section className="mt-8">
                ...
                <p>
                    ...
                    I am committed to transparency regarding your data. The following information provides a simple
                    overview of what happens to your personal data when you visit this website.
                </p>

                <h2 className="mt-8">2. Cookie Consent</h2>
                <p>
                    When you first visit my website, I ask for your consent to use cookies for analytics and advertising
                    purposes. You can choose to "Accept" or "Decline" this.
                </p>
                <p className="mt-4">
                    If you "Decline", I will not load Google Analytics or Google AdSense scripts, and no tracking
                ...
                <p className="mt-4">
                    <strong>Local Storage:</strong> I use your browser's local storage to save your timezone preferences
                ...
                <p>
                    <strong>Google Analytics:</strong> I use Google Analytics to understand how visitors interact
                    with the site. This service may collect data such as your IP address and browser type.
                </p>
                <p className="mt-4">
                    <strong>Google AdSense:</strong> I display advertisements via Google AdSense. Google uses cookies
                    to serve ads based on your previous visits to this and other websites.
                </p>

                <h2 className="mt-8">4. Font Hosting</h2>
                <p>
                    For the aesthetic design of my website, I use the "Inter" font.
                    This is provided via <strong>next/font</strong>, which means it is
                    <strong>self-hosted</strong> on my own server.
                </p>
                <p className="mt-4">
                    When you visit my site, your browser downloads this font directly from my server.
                ...
                <p>
                    For any privacy-related questions, please contact the website owner listed in my Impressum.
                </p>
            </section>
        </main>
    );
